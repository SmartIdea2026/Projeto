          ...
          <div className="campo__acoes">
            <button
              ...
              onClick={() =>
                void executar('github', () =>
                  window.ancoria.definirCredencial('github', token.trim())
                )
              }
            >
            ...
            {github?.estado === 'conectada' && (
              <button
                ...
                onClick={() =>
                  void executar('github', () => window.ancoria.removerCredencial('github'))
                }
              >
                Remover
              </button>
          ...
          */}
          ...
          <div className="campo__acoes">
            <button
              ...
              onClick={() =>
                void executar('drive', () =>
                  window.ancoria.definirClienteDrive(clientId.trim())
                )
              }
            >
              Salvar Client ID
            ...
            <button
              ...
              onClick={() => void executar('drive', () => window.ancoria.autorizarDrive())}
            >
            ...
            {drive?.estado === 'conectada' && (
              <button
                ...
                className="botao botao--secundario"
                onClick={() =>
                  void executar('drive', () => window.ancoria.removerCredencial('drive'))
                }
              >
                Desconectar
              </button>
