# Especificação do Sistema e Fluxo — AncorIA
...
Este documento especifica o sistema **AncorIA** conforme implementado no MVP. Ele descreve a arquitetura, o comportamento observável, os fluxos de uso e as regras vigentes.
...
O AncorIA é uma aplicação **desktop** de uso interno que centraliza a busca de documentos distribuídos entre **GitHub** e **Google Drive**.
...
```text
┌──────────────────────────────────────────────────────────┐
│ ⚓ AncorIA          [● GitHub conectada] [● Drive ...]   │
│    WORKSPACE INTERNO                                     │
├──────────────────────────────────────────────────────────┤
│                                                          │
